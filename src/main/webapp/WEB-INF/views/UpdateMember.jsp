...
<body>
    ...
    <div class="center-container">
        <form class="update-form" name="updateMemberForm" action="updateMember" method="post">
            <h2>회원 정보 수정</h2>
			<input type="text" name="mem_id" value="${loginMember.mem_id }" readonly="readonly">
    ...
    <script>
        ...
        function checkDuplicateEmail() {
            ...
            var loginMemberEmail = "<%= session.getAttribute("loginMember") != null ? ((MemberDTO) session.getAttribute("loginMember")).getMem_email() : "" %>";
            
            if (mem_email === loginMemberEmail) {
